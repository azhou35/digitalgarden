[[ai poetry]]
internet people prefer slop due to a lack of discernment
...
As we discussed earlier, AI poems do not reward further study. They don’t invite reflection, allow for complexity, or problematize the act of representing the world — the act of mimesis that art is and must struggle with.

That might actually be the experience of those who have already latently and implicitly developed their poetics, but it’s unhelpful
_De gustibus non est disputandum_

element. Not _novelty_, in the sense of like a poem that lacks the letter 'e' — rather the "charm of lyric", as Vendler writes
...
seems like there is no "_there_ there"; it seems that _I_, the reader, am the one doing the primary work, above and beyond the base rate of the contribution of reader-response in literature. We might call this by the loaded word "authenticity".
...
4. ![[Pasted image 20250405154815.png]]
5. CST = creativity support tool
6. [Verse by Verse](https://sites.research.google/versebyverse/)